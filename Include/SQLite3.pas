...
//修改2009-06-20：设置数据库密码（打开数据库后进行）
function SQLite3_Key(db: TSQLiteDB; pKey: PAnsiChar; nKey: Integer): Integer; cdecl; external SQLiteDLL name 'sqlite3_key';
//修改2009-06-20：修改或删除数据库密码（打开数据库后进行），要删除密码，则：PAnsiChar:=Nil
function SQLite3_Rekey(db: TSQLiteDB; pKey: PAnsiChar; nKey: Integer): Integer; cdecl; external SQLiteDLL name 'sqlite3_rekey';
